...
\begin{frame}[c]\frametitle{\secname}\centering
  Esses são slides de exemplo de como usar o tema \inline*{beamerthemeifrs}.
...
\begin{frame}[t]\frametitle{\secname}\framesubtitle{\subsecname}
  ...
  Porém, caso seja necessário, a logomarca ainda pode ser inserida com o comando \inline*{\textbackslash{}inserttitlegraphic} como aqui:\\
...
\begin{frame}[t]\frametitle{\secname}\framesubtitle{\subsecname}
  ...
  \begingroup
  \colorlet{textologo}{gray}
  \colorlet{vermelhologo}{textologo}
  \colorlet{verdelogo}{textologo}
    \inserttitlegraphic
  \endgroup
  \inserttitlegraphic
\end{frame}
...
\begin{frame}[t]\frametitle{\secname}\framesubtitle{\subsecname}
  ...
  Além disso, o texto também pode ser escrito em \verde{verde} ou em \verdito{``verdito''}.
\end{frame}
...
\begin{frame}[t]\frametitle{\secname}\framesubtitle{\subsecname}
  ...
  \begin{tabular}{I i l}
    \toprule
    \multicolumn{1}{l}{\verdito{Função}} & \multicolumn{1}{l}{\verdito{Biblioteca}} & \verdito{Descrição} \\
    \midrule
...
\begin{frame}[t,fragile]\frametitle{\secname}\framesubtitle{\subsecname}
  Para colocar um trecho maior de código, ocupando uma ou mais linhas, use o ambiente \inline*{snippet}. Por exemplo;
...
int fatorial(int n) {
  ...
  \end{snippet}
No entanto, é preciso passar a opção \inline*{fragile} para o \inline*{frame}.
\end{frame}

\begin{frame}[t,fragile]\frametitle{\secname}\framesubtitle{\subsecname}
  Tanto o comando \inline*{\textbackslash{}inline\{\}} quanto o ambiente snippet usa o pacote \inline*{listings}\footnote[frame]{Documentação na \href{http://mirrors.ctan.org/macros/latex/contrib/listings/listings.pdf}{CTAN}} para criar o realce de sintaxe.
...
\begin{frame}[t]\frametitle{\secname}\framesubtitle{\subsecname}
  \centering\verdito{Exemplo: Inline}
...
\begin{frame}[t,fragile]\frametitle{\secname}\framesubtitle{\subsecname}
  \centering\verdito{Exemplo: Snippet}
...
\begin{frame}[t]\frametitle{\secname}\framesubtitle{\subsecname}
  \centering\verdito{Exemplo: Arquivos}
...
\begin{frame}[t]\frametitle{\secname}\framesubtitle{\subsecname}%
  ...
  A expressão do volume em \eqref{eq:volume} é ``facilmente'' derivada, mas as definições de frutas apresentadas anteriormente no Slide~\slideref{slide:frutas} foram tiradas de um dicionário \cite{figueiredo1913novo}.
\end{frame}
...
\begin{frame}[t]\frametitle{\secname}\framesubtitle{\subsecname}
  ...
  Esse comando é o \inline*{\textbackslash{}makethanks\{\}} que recebe como parâmetro o agradecimento.
  ...
  \inline*{\textbackslash{}makethanks\{Obrigado pela oportunidade!\}}
  
\end{frame}

\makethanks{Obrigado pela oportunidade!}
